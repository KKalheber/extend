...
hostUrl | The base URL of the Auth0 Extend deployment to use. If you are an Auth0 Extend customer, this will be a URL that is unique to you. If you are trying out Auth0 Extend, you can get this parameter from [this page](https://auth0.com/extend/try). If not specified, defaults to `https://webtask.it.auth0.com`. 
